...
#     welcome_msg = "Добро пожаловать на наш сайт! Введите свое полное имя: " if data['language'] == 'Russian' else "Welcome to our bot! Enter your fullname: "
...
#
#     await UserState.next()
#     await message.answer('Введите вашу электронная почта: ' if data['language'] == 'Russian' else 'Enter your email: ')
#
...
#     await UserState.next()
#     await message.answer('Введите вашу адрес: ' if data['language'] == 'Russian' else 'Enter your address: ')
#
...
#
#         with open(f'{data["fullname"]}1.png', 'rb') as img_file1:
#             await message.answer_photo(img_file1)
#
#         with open(f'{data["fullname"]}2.png', 'rb') as img_file2:
